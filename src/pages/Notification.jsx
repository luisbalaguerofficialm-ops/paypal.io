          ...
          <section className="col-span-8 flex flex-col h-full space-y-6">
            <div className="flex justify-between items-end">
              ...
              <button
                ...
                className="weighted-gradient text-[#f7f7ff] px-6 py-2.5 rounded-md text-sm font-bold flex items-center gap-2 hover:opacity-70 transition-opacity bg-[#0053dc]"
              >
                <Plus size={16} />
                New Message
              </button>
              ...
              <div className="w-72 bg-[#f5f3f4] border-r border-[#b2b2b4]/10 flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-2 space-y-1">
                  ...
                  <div className="p-3 bg-[#ffffff] rounded-lg ring-1 ring-[#0053dc]/20 flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-[#3e76fe]/30 flex items-center justify-center text-[#0053dc]">
                      <AtSign size={18} />
                    </div>
                    <div className="truncate">
                      ...
                      <p className="text-[10px] text-[#0053dc] font-bold">
                        ACTIVE NOW
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex-1 flex flex-col bg-[#ffffff] relative">
                ...
                <div className="px-6 py-4 flex justify-between items-center bg-[#ffffff]/80 backdrop-blur-md border-b border-[#b2b2b4]/10">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#0053dc]"></div>
                  ...
                  <div className="flex gap-4">
                    <Video
                      size={20}
                      className="text-[#7a7a7d] cursor-pointer hover:text-[#0053dc]"
                    />
                    <Phone
                      size={20}
                      className="text-[#7a7a7d] cursor-pointer hover:text-[#0053dc]"
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-6">
                  ...
                  <div className="flex flex-col items-end ml-auto max-w-[80%]">
                    <div className="bg-[#0053dc] text-[#f7f7ff] px-5 py-4 rounded-2xl rounded-tr-none shadow-lg text-sm leading-relaxed">
                    ...
                    <span className="mt-2 text-[10px] font-bold text-[#0053dc] uppercase tracking-widest mr-1">
                      08:15 AM • You
                    </span>
                  </div>
                </div>
                  ...
                  <div className="relative flex items-center gap-4">
                    <div className="flex-1 bg-[#f5f3f4] rounded-xl px-4 flex items-center border-b-2 border-transparent focus-within:border-[#0053dc] transition-all">
                      ...
                      <div className="flex items-center gap-3 text-[#7a7a7d]">
                        <Paperclip
                          size={18}
                          className="cursor-pointer hover:text-[#0053dc]"
                        />
                        <Smile
                          size={18}
                          className="cursor-pointer hover:text-[#0053dc]"
                    ...
                    <button className="w-12 h-12 bg-[#0053dc] text-white rounded-xl flex items-center justify-center hover:bg-blue-700 transition-colors shadow-lg">
                      <Send size={20} />
                    </button>
                  </div>
                </div>
          ...
          <aside className="col-span-4 flex flex-col h-full space-y-6">
            ...
            <div className="flex-1 bg-[#ffffff] rounded-xl ring-1 ring-[#b2b2b4]/10 p-6 flex flex-col overflow-hidden">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-xs font-bold text-[#0053dc] hover:underline">
                  Mark all as read
                </button>
              </div>
